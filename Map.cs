...
namespace ConsoleProject_2
{
    ...
    "%                     |___/                                                                                                                                                             -=*+*#%##%##%@@@";
        ...
        //플레이어 공격 범위
        public static bool[,] playerAttackMap;

        //몬스터 공격 범위
        public static bool[,] monsterAttackMap;
        ...
        public static void InitMonsterAttackMap()
        {
            for (int i = 0; i < monsterAttackMap.GetLength(0); i++)
            {
                for(int j = 0; j< monsterAttackMap.GetLength(1); j++)
                {
                    monsterAttackMap[i, j] = false;
                }
            }
        }
        public static void InitMap(int width, int height)
        {
            ...
            playerAttackMap = new bool[width, height];
            monsterAttackMap = new bool[width, height];
        ...
        public static bool SetMonsterMap(int x, int y)
        {
            ...
            //몬스터의 공격
            if (monsterAttackMap[x, y])
            {
                for (int i = 0; i < 2; i++)
                {
                    for (int j = 0; j < 8; j++)
                    {
                        monsterAttackMap[x + j, y + i] = false;
                    }
                }
            }
            else
            {
                for (int i = 0; i < 2; i++)
                {
                    for (int j = 0; j < 8; j++)
                    {
                        monsterAttackMap[x + j, y + i] = true;

                        if (monsterAttackMap[x + j, y + i] && playerMap[x + j, y + i])
                        {
                            return true;
                        }
                    }
